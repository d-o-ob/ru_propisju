...
module RuPropisju
  ...
  TRANSLATIONS = {
    'ru' => {
      ...
      :aed_integral => ['дирхам', 'дирхама', 'дирхамов'],
      :aed_fraction => ['филс', 'филса', 'филсов'],
      :inr_integral => ['индийская рупия', 'индийские рупии', 'индийских рупий'],
      :inr_fraction => ['пайс', 'пайса', 'пайсов']
    },
    'ru_in' => { # Предложный падеж, например в 2 городах
      ...
      :byn_integral => ['белорусском рубле', 'белорусских рублях', 'белорусских рублях'],
      :byn_fraction => %w[копейке копейках копейках],
      :aed_integral => ['дирхаме', 'дирхамах', 'дирхамах'],
      :aed_fraction => ['филсе', 'филсах', 'филсах'],
      :inr_integral => ['индийской рупии', 'индийских рупий', 'индийских рупиях'],
      :inr_fraction => ['пайсе', 'пайсах', 'пайсах']
    },
    'ru_gen' => { # Родительный падеж, например в течение одного рабочего дня, пяти ночей (нуля рабочих дней)
       ...
       :byn_integral => ['белорусского рубля', 'белорусских рублей', 'белорусских рублей'],
       :byn_fraction => %w[копейки копеек копеек],
       :aed_integral => ['дирхама', 'дирхамов', 'дирхамов'],
       :aed_fraction => ['филса', 'филсов', 'филсов'],
       :inr_integral => ['индийской рупии', 'индийских рупий', 'индийских рупий'],
       :inr_fraction => ['пайса', 'пайсов', 'пайсов']
    },
    'ru_from' => {
      0 => "",
      '0' => "нулём",
      ...
      :byn_integral => ['белорусским рублем', 'белорусскими рублями', 'белорусскими рублями'],
      :byn_fraction => ['копейкой', 'копейками', 'копейками'],
      :aed_integral => ['дирхамом', 'дирхамами', 'дирхамами'],
      :aed_fraction => ['филсом', 'филсами', 'филсами'],
      :inr_integral => ['индийской рупией', 'индийскими рупиями', 'индийскими рупиями'],
      :inr_fraction => ['пайсом', 'пайсами', 'пайсами']
    },
    'ua' => {
      0 => "",
      '0' => "нуль",
      ...
      :jpy_integral => ['єна', 'єни', 'єн'],
      :jpy_fraction => ['сен', 'сіна', 'сенів'],
      :try_integral => ['турецька ліра', 'турецькі ліри', 'турецьких лір'],
      :try_fraction => ['куруш', 'куруши', 'курушів'],
      :byn_integral => ['білоруський рубль', 'білоруського рубля', 'білоруських рублів'],
      :byn_fraction => ['копійка', 'копійки', 'копійок'],
      :aed_integral => ['дирхам', 'дирхама', 'дирхамів'],
      :aed_fraction => ['філс', 'філса', 'філсів'],
      :inr_integral => ['індійська рупія', 'індійські рупії', 'індійських рупій'],
      :inr_fraction => ['пайс', 'пайса', 'пайсів']
    }
  }
